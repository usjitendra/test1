...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React19.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React19.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React19.useMemo(() => storageManager?.({
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React20.useContext(ColorSchemeContext) || defaultContext;
...
var prototypePollutingKeys = /* @__PURE__ */ new Set(["__proto__", "constructor", "prototype"]);
...
var SvgIcon = React27.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React27.isValidElement(children) && children.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
function createSvgIcon(path, displayName) {
  ...
  return React28.memo(React28.forwardRef(Component));
}
...
//# sourceMappingURL=chunk-VFRWDWMF.js.map
